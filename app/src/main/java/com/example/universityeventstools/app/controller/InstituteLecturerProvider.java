...
import com.example.universityeventstools.app.model.ServiceGroups;
 ...
 */
public class InstituteLecturerProvider {

    public Map<String, List<String>> getInstituteLecturers() {
        ...
        try {
            ...
            if (statusLine.getStatusCode() == HttpStatus.SC_OK) {
                ...
                ServiceGroups serviceGroups = gson.fromJson(tmp, ServiceGroups.class);
    ...
    public int getLecturerIdByName(String groupName) {
        final String groupsUrl = "http://env-4918584.jelastic.neohost.net/groups";
